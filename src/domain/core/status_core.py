...
class StatusCore:
    def __init__(self, deliveryman_storage: DeliverymanStorage, deliverys_storage: DeliverysStorage, status_message_broker: StatusMessageBroker):
        self.deliveryman_storage = deliveryman_storage
        self.deliverys_storage = deliverys_storage
        self.status_message_broker = status_message_broker

    def get_delivery(self, delivery_id):
        return self.deliverys_storage.get_by_id(delivery_id)
    ...
    def save_status(self, delivery, new_status):
        ...
        self.deliverys_storage.save(delivery)
